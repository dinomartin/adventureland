...
function say(message,code)
{
	...
	if(message[0]=="/")
	{
		...
		else if(command=="addgold" || command=="addshell" || command=="additem" || command=="addxp" || command=="setlevel" || command=="heal" || command=="teleport" || command=="goto" || command=="kill" || command=="respawn" || command=="gmhelp")
		{
